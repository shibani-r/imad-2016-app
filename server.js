    ...
    <!DOCTYPE html>
        <html>
            ...
            <body>
                ...
                <div class="w3-row-padding w3-padding-64 w3-container" id="article-content">
                    <div class="w3-content">
                        ...
                        <div class="w3-third w3-center">
                            <i class="fa fa-music w3-padding-64 w3-text-red "></i>
                        </div>
                ...
                <!--Quote of the day-->
                <div class="w3-container w3-center w3-opacity w3-padding-64" style="background: URL("http://www.intrawallpaper.com/static/images/Backgrounds-HD-3.jpg") no-repeat center center fixed;">
